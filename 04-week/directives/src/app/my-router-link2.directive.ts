...
export class MyRouterLink2Directive implements OnInit, OnDestroy {
  ...
  constructor(private elementRef: ElementRef, private renderer: Renderer2, private vc: ViewContainerRef) { 
    ...
    this.unsubs.push(this.renderer.listen(this.elementRef.nativeElement, 'click', this.mouseClickHandler));
  }
  ngOnInit(): void {
